...
date: 2020-12-17
slug: dealing-with-disruption
description:
  As various global restrictions related to the COVID-19 pandemic continue, so
  do disruptions to the operations of National Statistical Offices. This comes
  at a time when data remain key to inform evidence-based policymaking that
  addresses the manifold public health, economic, and social challenges
  countries face.
images:
  - ./nso-survey-rd3-chart1.png
  - ./nso-survey-rd3-chart2.png
  - ./nso-survey-rd3-chart3.png
  - ./nso-survey-rd3-chart4.png
---
...
- Read the full survey report:
  [Monitoring the State of Statistical Operations under the COVID-19 Pandemic – Round 3](/survey/covid-19-nso-survey-report-3.pdf)
